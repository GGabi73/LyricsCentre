...
function takeInputBoxValue() {
    ...
    if (x == 1) {
        ...
        artist = "Metallica";
        lyrics = lyricslist[1]
        cover = "Metallica_cover.jpg";
    } else if (x == 3) {
        title = "Livin of a Prayer";
        artist = "Bon Jovi";
        lyrics = lyricslist[2]
        cover = "LivinOnAPrayer.jpg";
    } else if (x == 4) {
        title = "California Love";
        artist = "2Pac";
        lyrics = lyricslist[3]
        cover = "CaliforniaLove.jpg";
    } else if (x == 5) {
        title = "All The Things She Said";
        artist = "t.A.T.u.";
        lyrics = lyricslist[4]
        cover = "tATu_attss.jpg";
    } else if (x == 6) {
        title = "My Way";
        artist = "Frank Sinatra";
        lyrics = lyricslist[5]
        cover = "My_Way_Frank_Sinatra.jpg";
    } else {
        lyrics = "";
        title = "Invalid ID";
        artist = "";
    ...
    document.getElementById("album cover").src = `cover/${cover}`;
}
